...
**Project root:** `/Users/example/packages/design-brain-memory`
...
Run: `cd /Users/example/packages/design-brain-memory && npm run build`
...
Run: `cd /Users/example/packages/design-brain-memory && npm run build && node --test tests/classify.test.mjs`
...
Run: `cd /Users/example/packages/design-brain-memory && npm run build && node --test tests/*.test.mjs`
...
Run: `cd /Users/example/packages/design-brain-memory && npm run build && node --test tests/scan.test.mjs`
...
Run: `cd /Users/example/packages/design-brain-memory && node --test tests/*.test.mjs`

Expected: All tests pass (util, query, persona, scan, classify).

**Step 3: Verify exported types**

Run: `cd /Users/example/packages/design-brain-memory && grep -r "AnimationToken" dist/types.d.ts`
